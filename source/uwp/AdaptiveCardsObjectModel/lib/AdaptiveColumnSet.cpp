...
namespace AdaptiveCards::ObjectModel::Uwp
{
    AdaptiveColumnSet::AdaptiveColumnSet() :
        m_bleedDirection(ABI::AdaptiveCards::Rendering::Uwp::BleedDirection::None)
    {
    ...
    try
    {
        ...
        m_bleedDirection =
            static_cast<ABI::AdaptiveCards::Rendering::Uwp::BleedDirection>(sharedColumnSet->GetBleedDirection());
    ...
    try
    {
        ...
        IterateOverVector<ABI::AdaptiveCards::Rendering::Uwp::AdaptiveColumn, IAdaptiveColumn>(m_columns.Get(), [&](IAdaptiveColumn* column) {
