...
namespace AdaptiveCards::ObjectModel::Uwp
{
    ...
    public:
        ...
        IFACEMETHODIMP get_Value(_Out_ ABI::Windows::Foundation::IReference<double>** value);
        IFACEMETHODIMP put_Value(ABI::Windows::Foundation::IReference<double>* value);

        IFACEMETHODIMP get_Max(_Out_ ABI::Windows::Foundation::IReference<double>** value);
        IFACEMETHODIMP put_Max(ABI::Windows::Foundation::IReference<double>* value);

        IFACEMETHODIMP get_Min(_Out_ ABI::Windows::Foundation::IReference<double>** value);
        IFACEMETHODIMP put_Min(ABI::Windows::Foundation::IReference<double>* value);
