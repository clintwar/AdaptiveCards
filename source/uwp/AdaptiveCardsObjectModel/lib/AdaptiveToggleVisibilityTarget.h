...
namespace AdaptiveCards::ObjectModel::Uwp
{
    ...
    public:
        ...
        IFACEMETHODIMP get_IsVisible(_Out_ ABI::AdaptiveCards::Rendering::Uwp::IsVisible* value);
        IFACEMETHODIMP put_IsVisible(ABI::AdaptiveCards::Rendering::Uwp::IsVisible value);
    ...
    private:
        ...
        ABI::AdaptiveCards::Rendering::Uwp::IsVisible m_visibilityToggle;
    };
